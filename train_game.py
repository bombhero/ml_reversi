        ...
        if r_value == 0:
            ...
            if second_r_value > 0.95:
                ...
                player_list = [RandomPlayer('Random', train_param.color_list[0], train_param.color_list[1],
                                            verbose=False),
                               AIPlayerW('NNTrain', train_param.color_list[1], train_param.color_list[0],
            ...
            print('AI vs AI')
            player_list = [AIPlayerW('NNTrainer', train_param.color_list[0], train_param.color_list[1],
                                     model_file_path=model_file, train_mode=True, verbose=False),
                           AIPlayerW('NNTeacher', train_param.color_list[1], train_param.color_list[0],
                                     model_file_path=model_file, train_mode=True, verbose=False)]
