...
from nn_player_h import ReversiCriticNetH
...
class NetTrain:
    def __init__(self, train_param):
        ...
        if os.path.exists(self.model_file):
            ...
            self.model = ReversiCriticNetH().to(self.calc_device)
            self.reload = False
    ...
    def train(self, epoch):
        ...
        dataloader = DataLoader(dataset=dataset, batch_size=int(len(dataset) / 500), shuffle=True, num_workers=4)
